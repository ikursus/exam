          ...
          <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <form class="form-horizontal" method="POST" action="{{ route('simpanrekodtambahexam') }}">
                      {{ csrf_field() }}
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="date" class="form-control" name="tarikh_mula" value="{{ old('tarikh_mula') }}" autofocus>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="date" class="form-control" name="tarikh_tamat" value="{{ old('tarikh_tamat') }}" autofocus>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" class="form-control" name="kuota" value="{{ old('kuota') }}" autofocus>
                          </div>
                      </div>
